...
# -----------------------------------------------------------------------------
    ...
    if selection != "5. Intelligent Customer Segmentation":
        with st.container():
            st.markdown(
                ...
                "color:#666;margin-bottom:6px;'>🔍 LEAD SELECTOR</div>",
    ...
    if row is not None:
        ...
        if selection == "2. Customer Identity Resolution":
            ...
            member_val  = esc(row.get("membership_id") or "—")
            ...
            st.markdown(
                "<div style='font-size:12px;font-weight:700;letter-spacing:1.5px;"
                "color:#666;margin-bottom:8px;margin-top:4px;'>📡 IDENTITY SIGNALS</div>",
                unsafe_allow_html=True,
            )
        ...
        # =====================================================================
            ...
            with right_col:
                ...
                st.markdown(dedent(f"""<div style="background:#1e1e2e;border:1px solid #2a2a4a;border-radius:12px;padding:22px 26px;">
        ...
        # =====================================================================
            ...
            st.markdown(
                "<div style='font-size:12px;font-weight:700;letter-spacing:1.5px;"
                "color:#666;margin-bottom:10px;'>📊 KEY PERFORMANCE INDICATORS</div>",
                unsafe_allow_html=True,
            )
            ...
            st.markdown(
                "<div style='font-size:12px;font-weight:700;letter-spacing:1.5px;"
                "color:#666;margin-bottom:8px;'>🚀 NEXT BEST ACTION</div>",
                unsafe_allow_html=True,
            )
